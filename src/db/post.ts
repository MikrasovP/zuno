...
const demoPosts: PostEntity[] = [
    {
        id: '1',
        title: 'Post 1',
        description: 'This is the first post',
        publishedTimestamp: BigInt(Date.now() - 5),
    ...
    },
    {
        ...
        publishedTimestamp: BigInt(Date.now() - 4),
  ...
  *This is italic text*
  ...
  `,
    },
    {
        ...
        publishedTimestamp: BigInt(Date.now() - 3),
    ...
    },
    {
        ...
        publishedTimestamp: BigInt(Date.now() - 2),
    ...
    },
    {
        ...
        publishedTimestamp: BigInt(Date.now() - 1),
...
export class Post {
    ...
    static async insertDemoPosts(): Promise<void> {
    ...
    static async getPaginatedWithoutContent(page = 1, limit = 10): Promise<PostWithAuthorModel[]> {
    ...
    static async getById(id: string): Promise<PostWithAuthorModel | null> {
